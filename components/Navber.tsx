...
const Navbar = () => {
  ...
  return (
    <header className="flex items-center justify-end md:justify-center">
      <nav className="border border-white/20 backdrop-blur-md bg-black/50 p-3 fixed top-5 z-30 rounded-2xl">
        <div className="container mx-auto flex items-end md:items-center justify-center">
          ...
          <div className="relative flex text-white hidden md:flex">
            ...
            {/* Moving Background */}
            <div
              className="border border-white/20 absolute rounded-lg bottom-0 h-full bg-white/20 transition-all duration-200 z-10"
              style={{
                left: barStyle.left,
